...
*/
@Entity
@Table(name="HJYW_QCZXXXB" )
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoHJYW_QCZXXXB implements com.hzjc.wsstruts.po.PO, java.io.Serializable {
	...
	*/
	...
	public Long getKdqqy_yhid(){
		return this.kdqqy_yhid;
	}

	public void setKdqqy_yhid(Long kdqqy_yhid){
		this.kdqqy_yhid=kdqqy_yhid;
	}

	public String getKdqqy_cgbz(){
		return this.kdqqy_cgbz;
	}
