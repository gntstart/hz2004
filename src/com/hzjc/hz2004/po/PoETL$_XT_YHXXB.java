...
/**
*HZ2004.XT_YHXXB表的修改量临时表，用于触发器新增和修改量抽取
*/
@Entity
@Table(name="ETL$_XT_YHXXB" )
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoETL$_XT_YHXXB implements com.hzjc.wsstruts.po.PO, java.io.Serializable {
