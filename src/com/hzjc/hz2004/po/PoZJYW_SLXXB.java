...
*/
@Entity
@Table(name="ZJYW_SLXXB" )
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoZJYW_SLXXB implements com.hzjc.wsstruts.po.PO, java.io.Serializable {
	...
	*/
	...
	public String getStjssj(){
		return this.stjssj;
	}

	public void setStjssj(String stjssj){
		this.stjssj=stjssj;
	}

	public String getBwbhd(){
		return this.bwbhd;
	}

	public void setBwbhd(String bwbhd){
		this.bwbhd=bwbhd;
	}
