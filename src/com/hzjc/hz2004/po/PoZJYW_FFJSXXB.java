...
*/
@Entity
@Table(name="ZJYW_FFJSXXB" )
@DynamicUpdate(true)
@DynamicInsert(true)
public class PoZJYW_FFJSXXB implements com.hzjc.wsstruts.po.PO, java.io.Serializable {
	...
	*/
	...
	public PoZJYW_FFJSXXB(){}

	public Long getFfjsid(){
		return this.ffjsid;
	}

	public void setFfjsid(Long ffjsid){
		this.ffjsid=ffjsid;
	}
