...
@Controller
@RequestMapping("/cx/edzjxx/zzfkcx")
public class ZzfkcxController extends BaseController{
	...
	@RequestMapping(value = { "/getZzfkxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getZzfkxx(params);
