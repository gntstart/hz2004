...
@Controller
@RequestMapping("/cx/hjywxx/hjsccx")
public class HjsccxController extends BaseController{
	...
	@RequestMapping(value = { "/getHjscxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getHjscxx(params);
