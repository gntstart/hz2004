...
@Controller
@RequestMapping("/cx/hjywxx/dycx")
public class DycxController extends BaseController{
	...
	@RequestMapping(value = { "/getDyxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getDyxx(params);
