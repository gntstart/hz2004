...
@Controller
@RequestMapping("/cx/edzjxx/ffjscx")
public class FfjscxController extends BaseController{
	...
	@RequestMapping(value = { "/getFfjsxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getFfjsxx(params);
