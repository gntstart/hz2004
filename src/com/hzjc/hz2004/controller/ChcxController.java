...
@Controller
@RequestMapping("/cx/hmzjxx/chcx")
public class ChcxController extends BaseController{
	...
	@RequestMapping(value = { "/getChxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getChxx(params);
