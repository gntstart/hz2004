...
@Controller
@RequestMapping("/cx/edzjxx/zlfkcx")
public class ZlfkcxController extends BaseController{
	...
	@RequestMapping(value = { "/getZlfkxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getZlfkxx(params);
