...
@Controller
@RequestMapping("/cx/hjywxx/swzxcx")
public class SwzxcxController extends BaseController{
	...
	@RequestMapping(value = { "/getSwzxxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getSwzxxx(params);
