...
@Controller
@RequestMapping("/cx/fsjshxx/xhcx")
public class XhcxController extends BaseController{
	...
	@RequestMapping(value = { "/getXhxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getXhxx(params);
