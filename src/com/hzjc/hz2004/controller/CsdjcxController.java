...
@Controller
@RequestMapping("/cx/hjywxx/csdjcx")
public class CsdjcxController extends BaseController{
	...
	@RequestMapping(value = { "/getCsdjxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.queryCsdjxx(params);
