...
@Controller
@RequestMapping("/cx/hjjbxx/thrycx")
public class ThrycxController extends BaseController{
	...
	public String index() {
		return "/cx/hjjbxx/thrycx";
	}
	
	//查询户籍审批业务表
	@RequestMapping(value = { "/queryThry"}, method = RequestMethod.POST)
	public ModelAndView queryPoHJSP_HJSPSQB() {
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.queryThry(params);
