...
@Controller
@RequestMapping("/cx/hmzjxx/sfzcx")
public class SfzcxController extends BaseController{
	...
	@RequestMapping(value = { "/getSfzxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getSfzxx(params);
