...
@Controller
@RequestMapping("/cx/hmzjxx/sfhfpcx")
public class SfhfpcxController extends BaseController{
	...
	@RequestMapping(value = { "/getSfhfpxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getSfhfpxx(params);
