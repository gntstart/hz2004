...
@Controller
@RequestMapping("/cx/hjywxx/hbbgcx")
public class HbbgcxController extends BaseController{
	...
	@RequestMapping(value = { "/getHbbgxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getHbbgxx(params);
	...
	@RequestMapping(value = { "/getHbbgxx1" }, method = RequestMethod.POST)
	public ModelAndView getQhxxFromHhid() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		
		return toJson(queryService.getQhxxFromHhid(params));
	}	
}
