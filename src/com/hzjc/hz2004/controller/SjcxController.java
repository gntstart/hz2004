...
@Controller
@RequestMapping("/cx/edzjxx/sjcx")
public class SjcxController extends BaseController{
	...
	@RequestMapping(value = { "/getSjxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getSjxx(params);
