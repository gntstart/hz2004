...
@Controller
@RequestMapping("/cx/edzjxx/tdcx")
public class TdcxController extends BaseController{
	...
	@RequestMapping(value = { "/getTdxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getTdxx(params);
