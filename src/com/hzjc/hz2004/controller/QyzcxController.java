...
@Controller
@RequestMapping("/cx/hmzjxx/qyzcx")
public class QyzcxController extends BaseController{
	...
	@RequestMapping(value = { "/getQyzxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getQyzxx(params);
