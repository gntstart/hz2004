...
@Controller
@RequestMapping("/cx/fsjshxx/shcx")
public class ShcxController extends BaseController{
	...
	@RequestMapping(value = { "/getShxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getShxx(params);
