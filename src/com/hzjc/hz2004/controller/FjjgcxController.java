...
@Controller
@RequestMapping("/cx/edzjxx/fjjgcx")
public class FjjgcxController extends BaseController{
	...
	@RequestMapping(value = { "/getFjjgxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getFjjgxx(params);
