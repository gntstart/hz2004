...
@Controller
@RequestMapping("/cx/hjywxx/bdqkcx")
public class BdqkcxController extends BaseController{
	...
	@RequestMapping(value = { "/getBdqkxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getBdqkxx(params);
