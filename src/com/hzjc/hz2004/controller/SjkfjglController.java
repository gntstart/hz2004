...
@Controller
@RequestMapping("/gl/sjkfjgl")
public class SjkfjglController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping(value = { "/querySjkfjgl" }, method = RequestMethod.POST)
	public ModelAndView queryJssdls() {
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.querySjkfjgl(params);
