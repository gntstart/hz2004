...
@Controller
@RequestMapping("/cx/hmzjxx/zqzcx")
public class ZqzcxController extends BaseController{
	...
	@RequestMapping(value = { "/getZqzxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getZqzxx(params);
