...
@Controller
@RequestMapping("/cx/hjywxx/hcybdcx")
public class HcybdcxController extends BaseController{
	...
	@RequestMapping(value = { "/getHcybdxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getHcybdxx(params);
