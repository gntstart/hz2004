...
@Controller
@RequestMapping("echarts/echartsZlNew")
public class EchartsZlNewController extends BaseController{
	...
	@RequestMapping(value = { "/querySsxqqrsffbbData" }, method = RequestMethod.POST)
	public ModelAndView querySsxqqrsffbbData() {
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		return toJson(queryService.querySsxqqrsffbbData(params));
	}
