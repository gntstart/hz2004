...
@Controller
@RequestMapping("/yw/ydbz/ydbzcx")
public class YdbzcxController extends BaseController{
	...
	public String index() {
		return "/yw/ydbz/ydbzcx";
	}
	
	@RequestMapping(value = { "/queryYdbzxx" }, method = RequestMethod.POST)
	public ModelAndView addDblkzxx() {
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		return toJson(queryService.queryYdbzxx(params));
	}
	@RequestMapping(value = { "/xxzf" }, method = RequestMethod.POST)
	public ModelAndView xxzf() {
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		return toJson(queryService.xxzf(params));
	}
