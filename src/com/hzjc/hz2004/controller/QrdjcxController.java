...
@Controller
@RequestMapping("/cx/hjywxx/qrdjcx")
public class QrdjcxController extends BaseController{
	...
	@RequestMapping(value = { "/getQrxx" }, method = RequestMethod.POST)
	public ModelAndView getQrxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.queryQrxx(params);
