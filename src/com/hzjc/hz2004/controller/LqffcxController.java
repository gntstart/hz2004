...
@Controller
@RequestMapping("/cx/edzjxx/lqffcx")
public class LqffcxController extends BaseController{
	...
	@RequestMapping(value = { "/getLqffxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getLqffxx(params);
