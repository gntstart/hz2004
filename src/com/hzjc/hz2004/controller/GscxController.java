...
@Controller
@RequestMapping("/cx/edzjxx/gscx")
public class GscxController extends BaseController{
	...
	@RequestMapping(value = { "/getGsxx" }, method = RequestMethod.POST)
	public ModelAndView getQcxx() {
		
		ExtMap<String, Object> params = CommonUtil.getRequestParamesObject(BaseContext.getContext().getRequest());
		Page p = queryService.getGsxx(params);
