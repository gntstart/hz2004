...
public class VoHjscspxxHqFhxx
  ...
  private String qybz; //户用标志

  //前台需要
  private Long sbhjywid; //上笔户籍业务ID
  private String hjsclb; //户籍删除类别

  public VoHjscspxxHqFhxx() {
  }

  public VoHjscspxxHqFhxx(PoHJSP_HJSCSPSQB poHjscspxx, PoHJXX_CZRKJBXXB poRyxx,
                          PoXT_SPDZB poSpdzxx) {

    try {
      if (poHjscspxx != null) {
        BeanUtils.copyProperties(this, poHjscspxx);
      }
      if (poRyxx != null) {
