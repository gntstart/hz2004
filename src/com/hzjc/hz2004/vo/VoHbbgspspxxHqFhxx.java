...
public class VoHbbgspspxxHqFhxx {
  ...
  public VoHbbgspspxxHqFhxx() {
  }

  public VoHbbgspspxxHqFhxx(PoHJSP_HBBGSPSQB poHbbgspsqxx,
                            PoHJXX_CZRKJBXXB poRyxx, PoHJSP_HJSPLSB poHjsplsxx,
                            PoXT_SPDZB poSpdzxx, PoXT_SPDZB poXyspdzxx) {
    try {
      if (poHbbgspsqxx != null) {
        BeanUtils.copyProperties(this, poHbbgspsqxx);
      }
      if (poRyxx != null) {
