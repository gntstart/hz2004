...
public class VoHbbgspxxHqFhxx
  ...
  public VoHbbgspxxHqFhxx() {
  }

  public VoHbbgspxxHqFhxx(PoHJSP_HBBGSPSQB poHbbgspxx, PoHJXX_CZRKJBXXB poRyxx,
                          PoXT_SPDZB poSpdzxx) {
    try {
      if (poHbbgspxx != null) {
        BeanUtils.copyProperties(this, poHbbgspxx);
      }
      if (poRyxx != null) {
