...
//		height:300,
	...
	var modifyJttdwh_window = new Gnt.ux.SelectJttdWhModify({
		//选择立户信息回调
		...
		items:[{
		    ...
		    items:[grid5009,{
			    ...
			    items:[{
					...
					handler:function(){
						if(selRes){
							modifyJttdwh_window.show(selRes,'single');
							modifyJttdwh_window.setSelRes(selRes,'single');
						}else{
							alert("请选择一条有效数据！");
							return;
						}
					...
					handler:function(){
						...
						modifyJttdwh_window.show(temp,'piliang');
						modifyJttdwh_window.setSelRes(plQueryData,'piliang');
					}
			    }),{
			    	height:3,
			    	border:false,
