...
Ext.onReady(function(){
	...
	var spxx_grid = new Gnt.ux.SjpzGrid({
		...
		region:'center',
    	title: '查询结果',
    	url: 'yw/spgl/hjsp/queryHjscspxxByUser.json',
		listeners:{
				         ...
				         new Ext.Button({
								...
								handler:function(){
									...
									(function(){
										...
										spcl_grid.store.removeAll();
										spcl_grid.loadData('6', selRes.data.spywid);
									}).defer(200);
								}
		    	         }),
		    	         new Ext.Button({
							...
							handler:function(){
								...
								Gnt.makeHzyw({
		   						...
		   						handler:function(){
		   							...
		   							Gnt.submit(
		   									{
		   										voHjscspspxx: Ext.encode([sub_data])
		   									}, 
		   									"yw/spgl/hjsp/processHjscspspyw", 
		   									"正在处理审批信息，请稍后...", 
		...
		items:[
				{
		    	   ...
		    	   frame:false,
				   borde:false,
		    	   html: '<center><br/><br/><br/><br/><h2>户籍删除审批业务完成！</center></h2>',
			   		buttons:[
			 	           new Ext.Button({
								text:'新办理',
								minWidth:100,
