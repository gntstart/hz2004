...
Ext.onReady(function(){
	//http://10.124.13.243:8280/dzda/jcLogin?idCard=hh&sfzh=341226198310100673
	var url = "http://10.124.13.243:8280/dzda/jcLogin?"+ "idCard=" + encodeURIComponent(user.usercode)+"&sfzh=" + user.gmsfhm ;
	window.open(url);
});