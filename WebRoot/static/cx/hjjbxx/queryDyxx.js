...
Ext.onReady(function(){
	...
	//本业务需要加载的配置
	if(!Gnt.loadSjpzb("20041",function(){}))
		return;
	...
	var sbxxGrid = new Gnt.ux.SjpzGrid({
		...
		listeners:{
			rowclick:function(g, rowIndex, e){
    			...
    			//人员基本资料更新
				form20041.getForm().reset();
				form20041.getForm().loadRecord(selRes);
