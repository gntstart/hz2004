...
Ext.onReady(function(){
	...
	//本业务需要加载的配置
	if(!Gnt.loadSjpzb("10019",function(){}))
		return;
		        ...
		        items:[{
			    		...
			    		bodyStyle:'padding:10px 25px 0px 20px',
		   	    	 	...
		   	    	 	items:[
								...
								minWidth:100,
								handler:function(){
									var selectHhnbid=sbxxGrid.getSelectionModel().getSelections()[0].data.hhnbid;
									var selectRynbid=sbxxGrid.getSelectionModel().getSelections()[0].data.rynbid;
