...
Ext.onReady(function(){
	...
	//本业务需要加载的配置
	if(!Gnt.loadSjpzb("20012",function(){}))
		return;
	...
	var sbxxGrid = new Gnt.ux.SjpzGrid({
		...
		listeners:{
			rowclick:function(g, rowIndex, e){
    			...
    			//人员基本资料更新
				form20012.getForm().reset();
				form20012.getForm().loadRecord(selRes);
...
//			rynbid:'3407000001001474234',
			config_key:'queryPoHJYW_HCYBDXXB'
		};
	store.load();
