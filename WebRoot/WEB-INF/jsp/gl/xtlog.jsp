...
<script type="text/javascript" src="js/yw/SelectDwxxWhModify.js?v=<%=Math.random()%>"></script>
<script type="text/javascript" src="js/yw/SelectDwxxWhAdd.js?v=<%=Math.random()%>"></script>
...
<script type="text/javascript" src="static/gl/xtlogform.js?v=<%=Math.random()%>"></script>
<script type="text/javascript" src="static/gl/xtlog.js?v=<%=Math.random()%>"></script>
