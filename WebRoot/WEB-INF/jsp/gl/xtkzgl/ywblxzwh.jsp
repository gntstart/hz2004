...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectYwblxzAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectYwblxzModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/gl/xtkzgl/ywblxzwh.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
