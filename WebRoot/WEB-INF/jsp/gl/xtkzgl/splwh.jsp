...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectSpmbWhAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectSpmbWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectSpdzlAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtkzgl/splwh.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
