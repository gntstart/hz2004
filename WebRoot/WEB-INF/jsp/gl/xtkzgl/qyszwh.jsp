...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectQyszAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtkzgl/qyszwh.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
