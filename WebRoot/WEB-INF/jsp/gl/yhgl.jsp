...
<html>
  ...
  <Script Lanaguage="JavaScript">
    ...
    <script type="text/javascript" src="js/yw/SelectYhWhAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectYhWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectGgyxipAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectSjfwAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectDtqxAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectYhdzqxAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/gl/yhgl.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
