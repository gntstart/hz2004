...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectJwhxxWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectJwhxxWhAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/JlxJwhWh.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtmbgl/jwhxxwh.js?v=<%=Math.random()%>"></script>
