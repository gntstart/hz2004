...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectJlxxxWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectJlxxxWhAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtmbgl/jlxxxwh.js?v=<%=Math.random()%>"></script>
