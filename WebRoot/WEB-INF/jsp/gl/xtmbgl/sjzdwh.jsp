...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectSjzdWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectSjzdWhAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtmbgl/sjzdwh.js?v=<%=Math.random()%>"></script>
