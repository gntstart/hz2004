...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectXzqhWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectXzqhWhAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtmbgl/xzqhwh.js?v=<%=Math.random()%>"></script>
