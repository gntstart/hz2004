...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectJlxjwhdzWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectJlxjwhdzWhAdd.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/xtmbgl/jlxjwhdzwh.js?v=<%=Math.random()%>"></script>
