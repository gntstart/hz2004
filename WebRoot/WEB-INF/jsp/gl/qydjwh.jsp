...
<html>
  ...
  <Script Lanaguage="JavaScript">
    ...
    <script type="text/javascript" src="js/yw/SelectQydjWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/ZdycxPanel.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/gl/qydjwh.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
