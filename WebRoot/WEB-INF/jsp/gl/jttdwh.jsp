...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectJttdWhModify.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/jttdwh.js?v=<%=Math.random()%>"></script>
