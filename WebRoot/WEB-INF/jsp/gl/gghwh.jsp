...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectGghWhModify.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/gl/gghwh.js?v=<%=Math.random()%>"></script>
