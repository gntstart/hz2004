...
<html>
  ...
  <Script Lanaguage="JavaScript">
    ...
    <script type="text/javascript" src="js/yw/zpupload.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectJwhZpAll.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/gl/jwhhzhqmwh.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
