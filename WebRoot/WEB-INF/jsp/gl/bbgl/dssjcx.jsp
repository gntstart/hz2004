...
<html>
	...
	<body>
    	...
    	<script type="text/javascript" src="static/gl/bbgl/dssjcx.js?v=<%=Math.random()%>"></script> 
    	<script type="text/javascript" src="js/readCard/readCard.js?v=<%=Math.random()%>"></script>
    	<script type="text/javascript" src="static/gl/bbgl/dssjcxform.js?v=<%=Math.random()%>"></script>
	     <div id="div1"></div>
	</body>
</html>
