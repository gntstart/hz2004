...
<html>
	...
	<body>
    	...
    	<script type="text/javascript" src="static/gl/bbgl/zsbbwh.js?v=<%=Math.random()%>"></script> 
  		<script type="text/javascript" src="static/gl/bbgl/ywbbwinadd.js?v=<%=Math.random()%>"></script> 
  		  		<script type="text/javascript" src="static/gl/bbgl/ywbbwinup.js?v=<%=Math.random()%>"></script> 
   		<OBJECT id="dellCell"  WIDTH=400 HEIGHT=200    classid="clsid:3F166327-8030-4881-8BD2-EA25350E574A" />
