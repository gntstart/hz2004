...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="js/SjpzUploadForm.js?v=<%=Math.random()%>"></script>
		...
		<script type="text/javascript" src="static/gl/ywslNavigation.js?v=<%=Math.random()%>"></script>
		<div id="div1"></div>
	</body>
</html>
