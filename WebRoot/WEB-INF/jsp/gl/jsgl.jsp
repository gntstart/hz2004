...
<html>
  ...
  <Script Lanaguage="JavaScript">
    ...
    <script type="text/javascript" src="js/yw/SelectJsWhAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectJsWhModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/gl/jsgl.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
