...
<body>
	...
	<script type="text/javascript" src="static/gl/sjcc/queryCzryxx.js?v=<%=Math.random()%>"></script>
	<script type="text/javascript" src="static/gl/sjcc/sjcxform.js?v=<%=Math.random()%>"></script>
	<div id="div1"></div>
</body>
</html>
