...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="js/yw/BzlsDialog.js?v=<%=Math.random()%>"></script>
		<script type="text/javascript" src="js/SjpzStore.js?v=<%=Math.random()%>"></script>
		...
		<script type="text/javascript" src="static/cx/edzjxx/edzslMain.js?v=<%=Math.random()%>"></script>
		<div id="div1"></div>
	</body>
</html>
