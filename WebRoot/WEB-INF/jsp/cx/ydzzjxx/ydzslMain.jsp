...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="js/yw/dkckdyForm.js?v=<%=Math.random()%>"></script>
		...
		<script type="text/javascript" src="static/cx/ydzzjxx/ydzslMain.js?v=<%=Math.random()%>"></script>
