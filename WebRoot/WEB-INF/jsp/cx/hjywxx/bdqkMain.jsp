...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="js/yw/SelectYwxx.js?v=<%=Math.random()%>"></script>
		...
		<script type="text/javascript" src="static/cx/hjywxx/bdqkMain.js?v=<%=Math.random()%>"></script>
		<div id="div1"></div>
	</body>
</html>
