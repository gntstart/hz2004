...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="static/yw/bbdy/wsbdy.js?v=<%=Math.random()%>"></script>
        <script type="text/javascript" src="static/yw/bbdy/wsbbdyform.js?v=<%=Math.random()%>"></script>    
