...
<body>
	...
	<script type="text/javascript" src="static/yw/bbdy/querySjsc.js?v=<%=Math.random()%>"></script>
	<script type="text/javascript" src="static/yw/bbdy/sbdyform.js?v=<%=Math.random()%>"></script>
