...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="static/yw/bbdy/cbddy.js?v=<%=Math.random()%>"></script>   
		<script type="text/javascript" src="static/yw/bbdy/cbdform.js?v=<%=Math.random()%>"></script>
