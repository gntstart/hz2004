...
<html>
	...
	<body>
	    ...
	    <script type="text/javascript" src="js/yw/SelectCphbbg.js?v=<%=Math.random()%>"></script>
		<script type="text/javascript" src="js/readCard/readCard.js?v=<%=Math.random()%>"></script>
    	<object id="LODOP" classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA" width=0 height=0></object>
		<script type="text/javascript" src="static/yw/hjyw/cphbbg.js?v=<%=Math.random()%>"></script>
		<div id="div1"></div>
	</body>
</html>
