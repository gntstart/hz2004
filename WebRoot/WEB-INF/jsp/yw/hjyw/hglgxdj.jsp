...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectGlh.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectHglgx.js?v=<%=Math.random()%>"></script>

    <script type="text/javascript" src="static/yw/hjyw/hglgxdj.js?v=<%=Math.random()%>"></script>
  </body>
</html>
