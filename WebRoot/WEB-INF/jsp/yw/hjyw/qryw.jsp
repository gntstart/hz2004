...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectRhByHu.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="js/yw/RhflWindow.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/hjyw/qryw.js?v=<%=Math.random()%>"></script>
