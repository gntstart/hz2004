...
<html>
	...
	<body>
	    ...
	    <script type="text/javascript" src="js/yw/SelectSfhfpbl.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/hjyw/sfhfpxxbl.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
  </body>
</html>
