...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/QhbgDialog.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="js/yw/selectBggzDialog.js?v=<%=Math.random()%>"></script>
    ...
    <script type="text/javascript" src="static/yw/hjyw/bggz.js?v=<%=Math.random()%>"></script>
