...
<html>
  ...
  <body>
	...
	<script type="text/javascript" src="js/yw/DzxgAddDialog.js?v=<%=Math.random()%>"></script>
	<script type="text/javascript" src="js/yw/DzxgModifyDialog.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/dzgl/dzwh.js?v=<%=Math.random()%>"></script>
  </body>
</html>
