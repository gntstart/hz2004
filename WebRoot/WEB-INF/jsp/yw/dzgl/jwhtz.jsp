...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="static/yw/dzgl/JwhGrid.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/dzgl/jwhtz.js?v=<%=Math.random()%>"></script>
  </body>
</html>
