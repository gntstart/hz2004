...
<html>
  ...
  <body>
	...
	<script type="text/javascript" src="js/yw/SelectNewHz.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/PrintDialog.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/spgl/spcl_hjblsp.js?v=<%=Math.random()%>"></script>
