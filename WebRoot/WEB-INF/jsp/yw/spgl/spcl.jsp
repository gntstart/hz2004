...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="static/yw/spgl/spcl.js?v=<%=Math.random()%>"></script>
    <div id="div1"></div>
    <iframe scrolling="auto" frameborder="0" width="0" height="0" src="yw/spgl/spcl/LoadIndex?goto=index"></iframe>
  </body>
</html>
