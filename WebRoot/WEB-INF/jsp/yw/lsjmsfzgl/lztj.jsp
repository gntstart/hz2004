...
<body>
	...
	<script type="text/javascript" src="static/yw/lsjmsfzgl/lztj.js?v=<%=Math.random()%>"></script>
   <script type="text/javascript" src="static/yw/lsjmsfzgl/tjsjdyform.js?v=<%=Math.random()%>"></script>
	<div id="div1"></div>
</body>
</html>
