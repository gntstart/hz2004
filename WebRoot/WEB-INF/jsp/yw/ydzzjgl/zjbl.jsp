...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/ZjblOneDialog.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SfzdyDialog.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/readCard/readCard.js?v=<%=Math.random()%>"></script>
   	<script type="text/javascript" src="static/yw/ydzzjgl/zjbl.js?v=<%=Math.random()%>"></script>
