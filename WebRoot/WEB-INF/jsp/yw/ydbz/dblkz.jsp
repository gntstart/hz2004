...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/yw/SelectDblkzAdd.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="js/yw/SelectDblkzModify.js?v=<%=Math.random()%>"></script>
    <script type="text/javascript" src="static/yw/ydbz/dblkz.js?v=<%=Math.random()%>"></script>
	<div id="div1"></div>
  </body>
</html>
