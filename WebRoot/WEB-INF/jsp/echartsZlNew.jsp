...
<html>
  <head>
		...
		<script type="text/javascript" src="../static/echartsZlNew.js"></script>
  </head>
  <body>
        ...
        <div class="sne-layout-box-top-middle">
            ...
            <div class="sne-layout-box-top-menu" id="title_menu" style="display:none;">
                <div class="sne-layout-box-top-menu-item">
                    <a href="echartsZlNew?theme=1">macarons</a>
                    <a href="echartsZlNew?theme=2">shine</a>
                    <a href="echartsZlNew?theme=3">dark</a>
                    <a href="echartsZlNew?theme=4">infographic</a>
                    <a href="echartsZlNew?theme=5">roma</a>
                </div>
            </div>
        </div>
        ...
        <div class="sne-layout-box-middle-middle">
            ...
            <div class="sne-content-layout1">
                ...
                <div class="sne-content-box">
                    <div class="sne-content-box-top1">
                        <div class="sne-sne-content-box-l1"></div>
                        <div class="sne-sne-content-box-l2 h35"></div>
                        <div class="sne-sne-content-box-l3"></div>
                    </div>
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2">
                            ...
                            <div style="position: relative;">
                                <div style="position: absolute;width: 68px;top: 50px;left: 10px;right: 0;bottom: 0;margin: 0 auto;text-align: center;">
                                    <div style="color: #deda00;font-size: 18px;line-height: 18px;" id="data_4_div_total"></div>
                                    <div style="color: #bfc4d7;font-size: 14px;line-height: 14px;"></div>
                                </div>
                                <!--echart 4-->
                                <!--<img src="../images/echart_4.png" alt="">-->
                                <div   id="data_4_div" class="liujfchart2" style="height: 118px;width:271px;"></div>
                            </div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
                        <div class="sne-sne-content-box-r1"></div>
                        <div class="sne-sne-content-box-r2 h35"></div>
                        <div class="sne-sne-content-box-r3"></div>
                    </div>
                </div>
                <!--box1 end-->
                ...
                <div class="sne-content-box">
                    <div class="sne-content-box-top1">
                        <div class="sne-sne-content-box-l1"></div>
                        <div class="sne-sne-content-box-l2 h63"></div>
                        <div class="sne-sne-content-box-l3"></div>
                    </div>
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2">
                            ...
                            <div style="position: relative;">
                                <div style="position: absolute;width: 68px;top: 50px;left: 10px;right: 0;bottom: 0;margin: 0 auto;text-align: center;">
                                    <div style="color: #deda00;font-size: 18px;line-height: 18px;" id="data_7_div_total"></div>
                                    <div style="color: #bfc4d7;font-size: 14px;line-height: 14px;"></div>
                                </div>
                                <!--echart 4-->
                                <!--<img src="../images/echart_4.png" alt="">-->
                                <div   id="data_7_div" class="liujfchart2" style="height: 145px;width:271px;"></div>
                            </div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
                        <div class="sne-sne-content-box-r1"></div>
                        <div class="sne-sne-content-box-r2 h63"></div>
                        <div class="sne-sne-content-box-r3"></div>
                    </div>
                </div>
                <!--box1 end-->
                ...
                <div class="sne-content-box">
                    ...
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2">
                            ...
                            <div id="data_3_div"  class="liujfchart2" style="height: 118px;width:261px;"></div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
            ...
            <div class="sne-content-layout2">
                ...
                <div class="sne-content-box">
                    ...
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2">
                            ...
                            <div   id="data_map_div" style="height: 546px;width:370px;"></div>
                ...
                <div class="sne-content-box">
                    <div class="sne-content-box-top1">
                        <div class="sne-sne-content-box-l1"></div>
                        <div class="sne-sne-content-box-l2 h93"></div>
                        <div class="sne-sne-content-box-l3"></div>
                    </div>
                    <div  class="sne-content-box-top2">
                        <div class="sne-sne-content-box-m1">当年人口流出
                            <!--<a href="#" class="sne-alink fr">详情</a>-->
                        </div>
                        <div class="sne-sne-content-box-m2 h180">
                            <!--echart 12-->
                            <!--<img src="../images/echart_12.png" alt="">-->
                            <div id="data_12_div"  class="data_map_div" style="height: 175px;width:370px;"></div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
                        <div class="sne-sne-content-box-r1"></div>
                        <div class="sne-sne-content-box-r2 h93"></div>
                        <div class="sne-sne-content-box-r3"></div>
                    </div>
                </div>
                <!--box1 end-->
                ...
                <div class="sne-content-box">
                    ...
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2 h224">
                            ...
                            <div id="data_8_div" class="liujfdiv liujfchart" style="height: 224px;width:690px;"></div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
                ...
                <div class="sne-content-box">
                    ...
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2 h224">
                            ...
                            <div id="data_9_div" class="liujfdiv liujfchart" style="height: 224px;width:690px;"></div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
                ...
                <div class="sne-content-box">
                    ...
                    <div  class="sne-content-box-top2">
                        ...
                        <div class="sne-sne-content-box-m2 h224">
                            <!--echart 9-->
                            <!--<img src="../images/echart_9.png" alt="">-->
                            <div id="data_11_div" class="liujfdiv liujfchart" style="height: 224px;width:690px;"></div>
                        </div>
                        <div class="sne-sne-content-box-m3"></div>
                    </div>
                    <div class="sne-content-box-top3">
