...
//        	Gnt.submit(
//        			{path: encodeURIComponent(node.attributes.path)},//处理中文文件名，乱码问题  , 
//					Ext.hoo.tree.FileSystemTree.TREE_DATA_URL, 
//					"正在加载中，请稍后...", 
//					function(jsonData){
...
Ext.hoo.tree.FileSystemTree.TREE_CREATE_DIR_URL = "yw/FileUtils/FileBrowser?method=mkDir";  
Ext.hoo.tree.FileSystemTree.TREE_DATA_URL = "yw/FileUtils/FileBrowser?method=getData"; 