Gnt.ux.SelectSpmbWhModify= Ext.extend(Ext.Window, {
	title:'审批模板修改',
	closeAction:'hide',
	modal:true,
	width:500,
	...
	show:function(selRes){
		...
		Gnt.ux.SelectSpmbWhModify.superclass.show.call(this);
	},
	    	...
	    	buttons:[
	    	 		{
	    	 			...
	    	 			minWidth:75,
	    	 			handler:function(){
	    	 				var rootWin = this.findParentByType("modifyspmbWindow");
...
//	    	 				}
	    	 			...
	    	 			minWidth:75,
	    	 			handler:function(){
	    	 				var win = this.findParentByType("modifyspmbWindow");
	    	 				win.hide();
	    	 			}
	    	 		}
	    	 	]
		...
		Gnt.ux.SelectSpmbWhModify.superclass.initComponent.call(this);
	}
	
	
});
Ext.reg('modifyspmbWindow', Gnt.ux.SelectSpmbWhModify);
