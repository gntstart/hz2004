Gnt.ux.SelectHhxlAdd= Ext.extend(Ext.Window, {
	title:'户号序列增加',
	closeAction:'hide',
	modal:true,
	width:300,
	...
	html:'',
	show:function(){
		Gnt.ux.SelectHhxlAdd.superclass.show.call(this);
	},
	setSelRes:function(){
...
//								id:'xzqhbdm',
	    	...
	    	buttons:[
	    	 		{
	    	 			...
	    	 			minWidth:75,
	    	 			handler:function(){
	    	 				var rootWin = this.findParentByType("addhhxl_window");
	    	 			...
	    	 			minWidth:75,
	    	 			handler:function(){
	    	 				var win = this.findParentByType("addhhxl_window");
	    	 				win.hide();
	    	 			}
	    	 		}
	    	 	]
		...
		Gnt.ux.SelectHhxlAdd.superclass.initComponent.call(this);
	}
	
	
});
Ext.reg('addhhxl_window', Gnt.ux.SelectHhxlAdd);
