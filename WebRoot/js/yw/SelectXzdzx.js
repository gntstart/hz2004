 ...
 */
Gnt.ux.SelectXzdzx = Ext.extend(Ext.Window, {
	title:'实际居住地注销',
	closeAction:'hide',
	modal:true,
	width:400,
	...
	initComponent : function(){
			...
			items:[
				{
					...
					frame: false,
					id: "panelHtmlId" ,
					html: '<div class="text"><h2>注销原因:</ h2></div>',
					region:'north',
					...
					items:[{
	                    ...
	                    listeners: {
	                        keyup: function(src, evt){
	                        	var win = this.findParentByType("xzdzx_window");
	                        	if(src.getValue()){
		...
		Gnt.ux.SelectXzdzx.superclass.initComponent.call(this);
	}
    
});
Ext.reg('xzdzx_window', Gnt.ux.SelectXzdzx);
